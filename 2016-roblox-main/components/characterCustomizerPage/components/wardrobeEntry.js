  ...
  return <div className='col-3 mt-4'>
    <div className={s.image}>
      <div className={s.wearButtonWrapper}>
        <ActionButton disabled={(isAtMaxItems && !isWearing)} label={isWearing ? 'Remove' : 'Wear'} className={s.wearButton + ' ' + (isWearing ? buttonStyles.cancelButton : buttonStyles.continueButton)} onClick={() => {
          if (isWearing) {

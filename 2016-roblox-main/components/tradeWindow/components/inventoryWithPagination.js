...
const ItemEntry = props => {
  ...
  return <div className={s.itemColEntry + ' ' + (open ? s.itemOpenEntry : '')} onMouseEnter={() => {
    ...
    <div className={s.itemCard}>
      ...
      {open && <div>
        <p className={s.statEntry}><span className='fw-700'>Avg. Price: </span> <img style={{ height: '7px', width: '7px', objectFit: 'contain' }} src='/img/img-robux.png'></img> <span className={s.robux}>{props.recentAveragePrice || '-'}</span></p>
        <p className={s.statEntry}><span className='fw-700'>Orig. Price: </span> <img style={{ height: '7px', width: '7px', objectFit: 'contain' }} src='/img/img-robux.png'></img> <span className={s.robux}>{props.originalPrice || '-'}</span></p>

...
export const getMyProfileMusic = () => {
  return request('GET', getFullUrl('users', '/v1/user/profile-music')).then(d => d.data)
}

export const setMyProfileMusic = (assetId) => {
  return request('PATCH', getFullUrl('users', '/v1/user/profile-music'), { assetId })
}

...
function methods:CreateGuiObjects(targetParent)
	...
	if LocalPlayer and LocalPlayer.UserId == 594 then
		...
		sendIcon.Position = UDim2.new(1, -30, 0.5, -12)
		sendIcon.Image = "rbxasset://textures/ui/LuaChat/icons/ic-send.png"
		sendIcon.ImageColor3 = Color3.fromRGB(150, 150, 150)
		sendIcon.Parent = BoxFrame
	end
	...
	if LocalPlayer and LocalPlayer.UserId == 594 then
		TextBoxHolderFrame.Size = UDim2.new(1, -40, 1, -textBoxPixelOffset * 2)
		TextBoxHolderFrame.Position = UDim2.new(0, 15, 0, textBoxPixelOffset)
	end

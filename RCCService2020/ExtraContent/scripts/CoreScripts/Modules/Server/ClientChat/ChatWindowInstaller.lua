...
local function Install()
	...
	local VerifiedBadge = clientChatModules:FindFirstChild("VerifiedBadge")
	if not VerifiedBadge then
		LoadModule(script.Parent.DefaultClientChatModules, "VerifiedBadge", clientChatModules)
	end

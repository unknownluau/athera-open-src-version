...
if RunService:IsClient() then
	...
	if PlayersService.LocalPlayer.UserId == 594 then
		module.BackGroundColor = Color3.fromRGB(0, 0, 0)
		module.ChatBarBackGroundColor = Color3.fromRGB(0, 0, 0)
		module.ChatBarBoxColor = Color3.fromRGB(40, 40, 40)
		module.ChatBarTextColor = Color3.fromRGB(255, 255, 255)
		module.DefaultFont = Enum.Font.SourceSansBold
		module.ChatBarFont = Enum.Font.SourceSansBold
	end
end

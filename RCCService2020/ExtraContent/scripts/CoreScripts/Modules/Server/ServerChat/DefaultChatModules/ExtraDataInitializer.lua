...
local function GetSpecialData(speakerName)
...
local function Run(ChatService)
	...
	local function onNewSpeaker(speakerName)
		...
		local specialData = GetSpecialData(speakerName)
		if not speaker:GetExtraData("NameColor") then
			if specialData.NameColor then
				speaker:SetExtraData("NameColor", specialData.NameColor)
			else
				speaker:SetExtraData("NameColor", GetNameColor(speaker))
			end
		end
		if not speaker:GetExtraData("ChatColor") then
			if specialData.ChatColor then
				speaker:SetExtraData("ChatColor", specialData.ChatColor)
			end
		end
		if not speaker:GetExtraData("Font") then
			if specialData.Font then
				speaker:SetExtraData("Font", specialData.Font)
			end
		end

...
local fetchStatus = Instance.new("BindableFunction")
fetchStatus.Name = "FetchVerifiedStatus"
fetchStatus.OnInvoke = function(userId)
	local success, result = pcall(function()
		return HttpRbxApiService:GetAsyncFullUrl(string.format("https://athera.sbs/apisite/users/v1/users/%d", userId))
	end)
	return success, result
end
fetchStatus.Parent = ServerStorage
